...
class _CalculatorState extends State<Calculator> {
      ...
      body: Padding(
        ...
        child: Column(
          ...
          children: [
            ...
            //now we'll cope above code and make more rows
            Row(
              mainAxisAlignment: MainAxisAlignment.spaceEvenly,
              children: [
                //here buttons function will be called
            ...
            SizedBox(height: 10.0),
            //same as above we will make more rows
            Row(
              mainAxisAlignment: MainAxisAlignment.spaceEvenly,
              children: [
                //here buttons function will be called
            ...
            SizedBox(height: 10.0),
            //now last row will be different as it has 0 buton
            Row(
              mainAxisAlignment: MainAxisAlignment.spaceEvenly,
              children: [
                ElevatedButton(
  ...
  //here we'll write calculator logic for the app
  dynamic text = '0';
  double numOne = 0;
  double numTwo = 0;
